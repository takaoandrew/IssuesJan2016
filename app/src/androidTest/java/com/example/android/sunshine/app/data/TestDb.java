...
import static com.example.android.sunshine.app.data.TestUtilities.TEST_LOCATION;
...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        assertTrue("Error: Row not added", cursor.moveToFirst());

        // Validate data in resulting Cursor with the original ContentValues
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        validateCurrentRecord("Wrong", cursor, testValues);
    ...
    public long insertLocation() {
        ...
        // query if you like)
        validateCurrentRecord("Wrong", cursor, testValues);
        assertFalse("Error: more than one row of data", cursor.moveToNext());
